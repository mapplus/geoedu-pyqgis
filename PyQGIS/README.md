...
# 참고사이트
  - PyQGIS
    - [https://qgis.org/pyqgis/3.0/](https://qgis.org/pyqgis/3.44/)
    - [https://qgis.org/api/modules.html](https://api.qgis.org/api/3.44/)

  - PyQT
    - [https://doc.qt.io/qtforpython-5/api.html](https://doc.qt.io/archives/qtforpython-5/api.html)
    - https://wikidocs.net/book/2944

  - GDAL/OGR(고급 사용자 추천)
    - [https://gdal.org/api/python.html](https://gdal.org/en/stable/api/python/index.html)
