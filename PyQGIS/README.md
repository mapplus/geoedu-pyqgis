...
Python 기초를 익힌 뒤, QGIS 객체를 직접 다루는 흐름으로 넘어가기 위한 학생용 실습 문서입니다.
...
- [VALIDATION_QGIS_3_44.md](./VALIDATION_QGIS_3_44.md): QGIS 3.44 기준 정적 검토 및 실행 검증 체크리스트

## 강사 메모

PyQGIS 입문에서는 처음부터 모든 클래스를 다루기보다 아래 흐름으로 반복시키는 편이 효과적입니다.

1. 레이어를 가져온다.
2. 유효성을 확인한다.
3. 피처를 순회한다.
4. 속성이나 지오메트리를 확인한다.
5. 필요한 결과를 새 레이어나 파일로 저장한다.
